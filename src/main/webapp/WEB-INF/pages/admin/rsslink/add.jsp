...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active">Add new RSS-Link</li>
	</ol>
</section>
	...
	<div class="row">
		...
		<div class="col-md-10 col-md-offset-1">
			...
			<div class="box box-primary">
				...
				<!-- /.box-header -->
				<!-- form start -->
				<c:url value="/admin/rsslink/save" var="action" />
				<form:form action="${action}" method="POST" accept-charset="UTF-8" modelAttribute="rssLink">
					<div class="box-body">
						<div class="row">
							<div class="col-xs-6">
								<label>RSS Name</label>
								<form:select class="form-control" path="rss" items="${rsses}" itemValue="id" itemLabel="name" />
							</div>
							
							<div class="col-xs-6">
								<label>Category Name</label>
								<form:select class="form-control" path="category" items="${categories}" itemValue="id" itemLabel="name" />
							</div>
						</div>
